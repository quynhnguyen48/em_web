export class ServiceApi {
  async getAll() {
    // var v = await axios.get("https://api.echomedi.com" + '/api/services');
  ...
  async findOne(slug: string) {
    var v = await fetch("https://api.echomedi.com" + '/api/service/findOne/' + slug)
    .then((response) => response.json());
    var blogs = v.package;
    // var v = await axios.get("https://api.echomedi.com" + '/api/service/findOne/' + slug);
    var blogs = v.service;
