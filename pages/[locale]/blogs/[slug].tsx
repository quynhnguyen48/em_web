...
const Blog = (props: InferGetStaticPropsType<typeof getStaticPropsBlog>) => {
  ...
  return (
    <>
      ...
      <SmallHero heading={""} message={""} sub_message={[]} image_url={"http://localhost:1337" + props.image_url} />
      <div className="p-4 mx-auto max-w-[864px]">
        <h1 className='mb-8 text-center'>{props.label}</h1>
