...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      axios.get('http://3.89.245.84:1337/api/product/getCart',
        {
          headers: {
      ...
      <div className="w-3/4 bg-white px-10 py-10">
        ...
        <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <div className="flex w-4/5">
            <div className="w-20">
              <img className="h-24 object-contain" src={"http://3.89.245.84:1337" + line.product.image?.url} alt=""/>
            </div>
            <div className="flex flex-col justify-between ml-4 flex-grow">
              <span className="font-bold text-sm">{line.product.label}</span>
          ...
          <span className="text-center w-1/5 font-semibold text-sm">{numberWithCommas(line.product.price)}đ</span>
        </div>)}
