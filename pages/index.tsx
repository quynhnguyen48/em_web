...
const Home: NextPage = () => {
  ...
  return (
	...
	c21.2-8.1,52.2-18.2,79.7-24.2C399.3,7.9,411.6,7.5,421.9,6.5z"></path>
      ...
      <div id="" className="max-w-[1240px] mx-auto text-center">
      ...
      <div className="grid grid-rows-none md:grid-cols-4 grid-cols-2 p-4 gap-4 mb-8">
        <div className="md:col-span-1 row-span-2 flex flex-col	items-center">
          <Link href={"/packages/cham-soc-phong-ngua/"}>
            <div className="cursor-pointer flex flex-col items-center bg-green-100 p-4 hover:bg-green-200 rounded-2xl">
