...
const Modal = ({
  ...
  return (
    <>
      <div
        className={`m-auto px-6 justify-center items-center flex overflow-hidden fixed inset-0 outline-none focus:outline-none transition-all duration-300 w-[940px] ${wrapperClassName} ${
