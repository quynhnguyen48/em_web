  ...
  return (
    ...
    className="grid grid-rows-none md:grid-cols-3 p-4 gap-4 text-white p-10">
      ...
      <div className="w-full h-full col-span-2 md:col-span-1 row-span-2">
        ...
        <p>{locale === "en" ? " + 46 Nguyen Thi Dinh, An Phu Ward, District 2, Thu Duc City" : "+ 46 Nguyễn Thị Định, P.An Phú, TP.Thủ Đức,TPHCM"}</p>
      ...
      <div className="w-full h-full col-span-2 md:col-span-1 row-span-2">
        ...
        <div className="mt-16 flex flex-row w-60 grid grid-cols-3 md:grid-cols-3  text-white">
