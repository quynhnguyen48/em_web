    ...
    <div id="gallery" className="w-full mx-auto">
      <div className="relative flex justify-center h-[350px] md:h-[750px]">
        <Swiper className="mySwiper" autoplay={true}>
          ...
          <SwiperSlide>
            <div className="z-10">
            <p className="font-semibold z-10 text-white text-[50px]">{locale === "en" ? "ENTRUST YOUR WELLBEING TO US" : "CHO MỘT SỨC KHOẺ TOÀN DIỆN"}</p>
            </div>
          ...
          <SwiperSlide>
          <p className="font-semibold z-10 text-white text-[50px]">{locale === "en" ? "HEALTHCARE EVOLVED" : "NÂNG TẦM SỨC KHOẺ"}</p>
