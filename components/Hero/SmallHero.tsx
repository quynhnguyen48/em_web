...
const SmallHero = ({ heading, message, image_url, sub_message, image_placeholder_url }: Props) => {
  ...
  return (
    <div className="flex items-center justify-center h-[200px] mt-[100px] bg-fixed bg-center bg-cover"
      ...
      {/* <LazyLoadImage
        ...
        className="w-full"
              ...
              placeholderSrc={image_url}
               /> */}
      <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/70 z-[2] h-[200px] mt-[100px]" />
